    ...
    void deleteTri(int index)
    {
        ...
        while(j < mesh.triangles.Length)
        {
            ...
            else
            {
                ...
                GameObject poof = new GameObject("bruh", typeof(MeshFilter), typeof(MeshRenderer), typeof(Rigidbody), typeof(BoxCollider));
                poof.transform.position = new Vector3(0,20,0);
